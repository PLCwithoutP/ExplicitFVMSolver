...
def calculatePressure(Q):
    e_int = (Q[4]/Q[0]) - (0.5*(Q[1]**2 + Q[2]**2 + Q[3]**2))/(Q[0]**2)
    #print("Internal e: ", e_int)
    p = max(e_int * Q[0] * (gamma - 1),0)
    return p
...
def calculateLeftRightMach(n, u_L, u_R, a_12):
    M_L = (n[0]*u_L[0] + n[1]*u_L[1] + n[2]*u_L[2])/a_12
    M_R = (n[0]*u_L[0] + n[1]*u_L[1] + n[2]*u_L[2])/a_12
    return M_L, M_R
